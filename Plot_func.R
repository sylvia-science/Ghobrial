plotAll = function(data,folder,sample_name,filter,regress_TF,label_TF){
  print(sample_name)
  print(folder)
  ...
  # Name cells
  if (label_TF){
    data = label_cells(data,sample_name,sampleParam)
  }
...
plotAllIntegrate = function(data,folder,sample_name,sampleParam,label_TF){
  ...
  # Split by orig ident
  pathName <- paste0(folder_output[1],paste0('Cluster/ClusterUmap_split_',resolution_val,file_str,'.png'))  
  png(file=pathName,width=600, height=350)
