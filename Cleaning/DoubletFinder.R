...
for (i in 1:nrow(metaData) ){
  ...
  folder = paste0('/home/sujwary/Desktop/scRNA/Output/','DoubletFinder/',sample_name,'/')
  ...
  for (j in 1:length(gene_list)){
    ...
    print(gene)
    #browser()
    folder = paste0('/home/sujwary/Desktop/scRNA/Output/DoubletFinder/',sample_name,'/','Featureplots/Pre_Doublet_Umap/')
    dir.create(folder,recursive = T)
  ...
  for (j in 1:length(gene_list)){
    ...
    print(gene)
    #browser()
    folder = paste0('/home/sujwary/Desktop/scRNA/Output/DoubletFinder/',sample_name,'/','Featureplots/Post_Doublet_Umap/')
    dir.create(folder,recursive = T)
...
for (i in 1:nrow(metaData) ){
  ...
  folder_name = 'Soup_Empty_MT_DoubletFinder'
