...
for (i in 1:nrow(metaData) ){
  ...
  write.csv(scran_doublet, file=paste0(folder, 'Doublet','.csv'))
  ...
  print('Plot')
  pathName = paste0(folder,sample_name,'_Pre_Doublet_Umap','scran_doublet','.png')
  png(file=pathName,width=1000, height=1000)
  ...
  for (j in 1:length(gene_list)){
    ...
    print(gene)
    #browser()
    folder = paste0('/home/sujwary/Desktop/scRNA/Output/scran_Doublet/',sample_name,'/','Featureplots/Pre_Doublet_Umap/')
    dir.create(folder,recursive = T)
